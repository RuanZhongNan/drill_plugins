...
　　var Moghunter = Moghunter || {}; 
  ...
  　Moghunter.parameters = PluginManager.parameters('MOG_TitleSplashScreen');
    ...
    Moghunter.title_full_screen_mode = String(Moghunter.parameters["是否初始全屏"] || "false") == "true";
    Moghunter.title_play_music = String(Moghunter.parameters["是否初始播放音乐"] || "false") == "true";
	Moghunter.title_play_music_src = String(Moghunter.parameters['背景音乐'] || "");
...
// ** 启动画面背景音乐
//=============================================================================
Scene_Splash_Screen.prototype.playSplashMusic = function() {
	var bgm = {};
	bgm.name = Moghunter.title_play_music_src;
	bgm.pitch = 100;
	bgm.volume = 100;
...
Scene_Splash_Screen.prototype.update = function() {
	...
	if( Moghunter.title_play_music === true ){
		Moghunter.title_play_music = false;
