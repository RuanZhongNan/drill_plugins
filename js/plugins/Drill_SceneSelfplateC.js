...
// * 显示窗口 - 重绘内容
//==============================
Drill_SSpC_DescWindow.prototype.drill_refreshDesc = function(index) {
	// > 获取当前选项的描述内容
	var cur_index = index;
	var temp_data = $gameTemp._drill_SSpC_visibleList[ cur_index ];
	var context_list = temp_data['context'];
	if( temp_data['locked'] ){
		context_list = DrillUp.g_SSpC_locked_context;
	}
