...
//=============================================================================
 /*:
 * @plugindesc (v1.51)[v1.2] 地图 - 多光源特效
 ...
 * ★★该插件功能和配置较复杂，目前也没有文档，请耐心摸索★★
 *
 * -----------------------------------------------------------------------------
 * ----设定注意事项
 * 1.插件的作用域：地图界面。
 *   事件、玩家可以有光源效果。
 * 2.该插件与 MOG_LimitedVisibility.js  地图–简单光源精灵 的功能是一样的。
 *   （二者可以叠加使用，但是效果差强人意。）
 * 3.必须要满足两个条件才会有光源效果：
 *    含事件备注的事件 + 插件指令开启
 *
 ...
 * 时间复杂度： 未估计
 * 测试方法：   仅仅是去光源管理层跑了一趟。
 * 测试结果：   20个事件的地图中，平均消耗为：【231.66ms】
 *
 * 1.插件只在自己作用域下工作消耗性能，在其它作用域下是不工作的。
 *   测试结果并不是精确值，范围在给定值的10ms范围内波动。
 *   更多了解插件性能，可以去看看"关于插件性能.docx"。
 * 2.插件可能没有经过优化，地图界面中即使关闭光源，插件仍然在消耗。
 *   只是消耗稍微少一半而已。
 *   而开启了光源，消耗量巨大。
 *
 * -----------------------------------------------------------------------------
