 ...
 * 设计：
 *   (1.全自定义信息面板插件 中的 选项窗口 可以指定使用该指针的某种样式。
 *      按钮组也可以指定 某种样式，用于不同装饰效果。
 *   (2.配置指针可以是圆环，可以是一个指向标，也可以是一个大外框。
 *      并且支持gif多张图设计一个动态指针。
 * 
 * -----------------------------------------------------------------------------
 * ----可选设定
 ...
 * @param 偏移-指针 X
 * @parent ---常规---
 * @desc 以指针的位置为基准，x轴方向平移，单位像素。（可为负数）
 * @default 0
 * 
 * @param 偏移-指针 Y
 * @parent ---常规---
 * @desc 以指针的位置为基准，y轴方向平移，单位像素。（可为负数）
 * @default 0
 * 
 * @param 资源-菜单指针
 * @parent ---常规---
...
//=============================================================================
// ** 强制鼠标滚轮切换选项（默认rmmv的鼠标滚动，真就是翻页，而不是切换选项）
//=============================================================================
