...
　　var DrillUp = DrillUp || {}; 
	...
	DrillUp.g_SSpH_selWin_menuCursorEnabled = String( DrillUp.parameters['是否启用mog菜单指针'] || "true") == "true";
	DrillUp.g_SSpH_selWin_menuCursorBorderEnabled = String( DrillUp.parameters['是否启用mog菜单边框'] || "true") == "true";
...
if( Imported.MOG_MenuCursor == true ){
	...
	Drill_SSpH_SelectWindow.prototype.need_set_mcursor_data = function() {
		if( DrillUp.g_SSpH_selWin_menuCursorEnabled == false ){
			return false;
		}
...
if( Imported.MOG_CursorBorder == true ){
	...
	Drill_SSpH_SelectWindow.prototype.createSprSelMenu = function() {
		if( DrillUp.g_SSpH_selWin_menuCursorBorderEnabled == false ){
			return ;
		}
